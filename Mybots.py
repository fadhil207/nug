...
#ki4 = LINETCR.LINE()
#ki4.login(token="EmRCXCfTOR6CoJNtqgh1.QTuxmvC72dh7531FEEFKmq.ZlLkm29ZT4oKoPYhBDZkJ6bUGS75nqthHyiRhMsrcME=")
#ki4.loginResult()
...
#-----------------------------------------------------------
                     ...
                     if targets == []:
                         ...
                         for target in targets:
                             try:
                                cl.getContactProfile(target)
                                cl.updateProfilePicture(target)
...
#--------------------------------------------------------
                ...
                if wait["clock"] == True:
                    ...
                    cl.sendText(msg.to,"Turn on Your Clock Name")
