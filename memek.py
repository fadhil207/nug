...
cl = LINETCR.LINE()
cl.login(token="EmjqKvPhiW9NdEegQ2z2.Skq32mqBkuNH3J/isSmUaG.e959/tjFAeVc4xn+0TE4+3EztQD7bH+qt0DIsBOQHwM=")
cl.loginResult()
...
#-----------------------------------------------
              ...
              if msg.toType == 2:
                ...
                try:
                    ki5.findAndAddContactsByMid(gCreator)
                    ki5.inviteIntoGroup(msg.to,[gCreator])
